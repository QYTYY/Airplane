...
{
    ui->setupUi(this);
   loadData("C:\\Users\\24085\\OneDrive\\Desktop\\plane\\untitled\\user.txt");
}
Widget::~Widget()
{
    delete ui;
...
void Widget::on_login_released()
{
    ...
    if(re == 0) {
        QFile file("C:\\Users\\24085\\OneDrive\\Desktop\\plane\\untitled\\user.txt");
        ...
        file.close();
        this->loadData("C:\\Users\\24085\\OneDrive\\Desktop\\plane\\untitled\\user.txt");
        //this->close();
        //flight *f = new flight();
        //f->show();
    }
